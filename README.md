...
#### `metrics-[tag].csv` – Metrics data for HN GH-AI projects.
Metric tags include the following:
- `hn-gh-ai`: Metric data for HN GH-AI stories.
- `hn-gh-ai-5months-[no-dupes]`: Metric data for HN GH-AI stories which has been converted into relative 5 months after HN submission date. This was generated by running `rq3/3b-hn-effects-sentiment-growth/convert-to-relative-hn-date.py`.
- `hn-gh-ai-[6-months-before-after-hn]`: AI stories containing GitHub repository URL which has been created at least 6 months before HN submission as well as containing metrics 6 months afterwards. This is to ensure sufficient project activities, and was used for statistical analysis and DiD. Note that this **does not contain relative months** after HN submission, only a list of raw metrics for the repositories that fit the 6 months before and after criteria. This was generated by running `rq3/3a/filter-6months-before-after-hn.py`.
